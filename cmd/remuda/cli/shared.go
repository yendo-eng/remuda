...
func (o *AgentSessionOptions) register(cmd *cobra.Command, fl *flagSet) {
	...
	fs.StringVar(&o.ReasoningLevel, "reasoning-level", "", "Reasoning level for codex/claude (none|minimal|low|medium|high|xhigh for codex; low|medium|high|xhigh|max for claude).")
